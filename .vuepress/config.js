module.exports = {
  ...
  head: [
    ['link', { href: '/fontawesome/css/all.min.css', rel: 'stylesheet' }],
      ['link', { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Noto+Sans+JP:100,300,700&display=swap&subset=japanese' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '', link: 'https://surveys.hotjar.com/s?siteId=1346481&surveyId=135747', awesome: 'fas fa-paper-plane'
      }
    ],
    sidebar: [
      {
